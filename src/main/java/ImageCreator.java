...
public class ImageCreator {
    ...
    private List<Coordinate> getListOfSet(int set, Date from, Date to, String exercise, GraphType graphType) {
        ...
        for (Map.Entry<Date, List<TrainingSet>> m : dataManger.getStatsBetweenDates(exercise, from, to).entrySet()) {
            if(m.getValue().size() >= set) {
                ...
                if (graphType == GraphType.EFFECTIVE_GRAPH){
                    graphTypeValue = (double)(m.getValue().get(set-1).getReps()*m.getValue().get(set-1).getWeight());
                }else if(graphType == GraphType.WEIGHT_GRAPH){
    ...
    private Color getColorOfSet(int set){
        switch(set){
            ...
            case 3: return Color.decode("#34792F");
            case 4: return Color.MAGENTA;
            case 5: return Color.ORANGE;
            case 6: return Color.YELLOW;
            case 7: return new Color(0x2efe12);
            case 8: return new Color(0x56c3bb);
            case 9: return new Color(0xa0429f);
            case 10: return new Color(0x9e1778);
            case 11: return new Color(0xec7511);
            case 12: return new Color(0xc019c6);
            case 13: return new Color(0x9a87f8);
            case 14: return new Color(0x5f1073);
            case 15: return new Color(0x253fb2);
